...
def core(clk,
    ...
    imem_wait = intbv(0)[1:]
    imem_addr = intbv(0)[HASTI_ADDR_WIDTH:0]
    imem_rdata = intbv(0)[HASTI_BUS_WIDTH:0]
    imem_badmem_e = intbv(0)[1:]
    dmem_wait = intbv(0)[1:]
    dmem_en = intbv(0)[1:]
    dmem_wen = intbv(0)[1:]
    dmem_size = intbv(0)[HASTI_SIZE_WIDTH:0]
    dmem_addr = intbv(0)[HASTI_ADDR_WIDTH:0]
    dmem_wdata_delayed = intbv(0)[HASTI_BUS_WIDTH:0]
    dmem_rdata = intbv(0)[HASTI_BUS_WIDTH:0]
    dmem_badmem_e = intbv(0)[1:]

    htif_ipi_req_valid = intbv(0)[1:]
    htif_ipi_req_data = intbv(0)[1:]
    htif_ipi_resp_ready = intbv(1)[1:]
